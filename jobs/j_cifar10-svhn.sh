...
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/sunwbgt_root/sunwbgt98/xysong/ATD/out/cifar10-svhn.log
...
python test_ATD.py  --run_name cifar10-svhn --model_type "fea" --in_dataset cifar10-svhn --batch_size 128 --eps 0.0313 --attack_iters 100 \
