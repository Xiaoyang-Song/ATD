...
python train_ATD.py  --run_name cifar10-svhn-Balanced-256 --model_type "fea" --training_type "adv" \
...
python test_ATD.py  --run_name cifar10-svhn-Balanced-256 --model_type "fea" --in_dataset cifar10-svhn --batch_size 256 --eps 0.0313 --attack_iters 100 \
